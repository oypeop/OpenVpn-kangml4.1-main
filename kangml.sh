...
clear
cd /var/www/html/
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/kangml-update.zip
...
Install_Fuzai()
{
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/kangfz.sh
}

Install_App()
{
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/kangapp.sh
}
...
rpm -Uvh https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/liblz4-1.8.1.2-alt1.x86_64.rpm --force --nodeps > /dev/null 2>&1
rpm -Uvh https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/openvpn-2.4.3-1.el7.x86_64.rpm --force --nodeps > /dev/null 2>&1
...
wget -qO /etc/nginx/conf.d/default.conf https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/default.conf > /dev/null 2>&1
sed -i 's/listen 80/listen 1234/g' /etc/nginx/conf.d/default.conf > /dev/null 2>&1
systemctl start nginx > /dev/null 2>&1
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/ixed.7.4.lin -P /opt/remi/php74/root/usr/lib64/php/modules/ > /dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/dnsmasq.conf -P /etc > /dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/openvpn.zip > /dev/null 2>&1
cd /etc/openvpn > /dev/null 2>&1
...
cd
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/shvpn > /dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/res.zip > /dev/null 2>&1
...
cd /bin > /dev/null 2>&1
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/bin.zip > /dev/null 2>&1
cd /bin > /dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/kangml_web.zip > /dev/null 2>&1
...
cd /APP > /dev/null 2>&1
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/kangml.apk > /dev/null 2>&1
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/apktool.jar > /dev/null 2>&1
...
wget -q https://raw.githubusercontent.com/oypeop/OpenVpn-kangml4.1-main/main/centos/signer.zip > /dev/null 2>&1
